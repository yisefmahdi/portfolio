<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					<li class="side-item side-item-category">الاساسية</li>
					<li class="slide">
						<a class="side-menu__item" href="{{ route('dashboard.order') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24" ><path d="M0 0h24v24H0V0z" fill="none"/><path d="M5 5h4v6H5zm10 8h4v6h-4zM5 17h4v2H5zM15 5h4v2h-4z" opacity=".3"/><path d="M3 13h8V3H3v10zm2-8h4v6H5V5zm8 16h8V11h-8v10zm2-8h4v6h-4v-6zM13 3v6h8V3h-8zm6 4h-4V5h4v2zM3 21h8v-6H3v6zm2-4h4v2H5v-2z"/></svg><span class="side-menu__label">طلبات الاعلانات</span></a>
					</li>
                    <li class="slide">
						<a class="side-menu__item" href="{{ route('dashboard.message') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24" ><path d="M0 0h24v24H0V0z" fill="none"/><path d="M5 5h4v6H5zm10 8h4v6h-4zM5 17h4v2H5zM15 5h4v2h-4z" opacity=".3"/><path d="M3 13h8V3H3v10zm2-8h4v6H5V5zm8 16h8V11h-8v10zm2-8h4v6h-4v-6zM13 3v6h8V3h-8zm6 4h-4V5h4v2zM3 21h8v-6H3v6zm2-4h4v2H5v-2z"/></svg><span class="side-menu__label">تواصل معنا</span></a>
					</li>

                    <li class="side-item side-item-category">معلومات سيارات</li>
					<li class="slide">
						<a class="side-menu__item" href="{{ route('dashboard.marca') }}">
                            <i class="fa fa-map-marker text-dark" aria-hidden="true"></i>
                            <span class="side-menu__label mr-2"> علامات </span>
                        </a>
					</li>
                    <li class="slide">
						<a class="side-menu__item" href="{{ route('dashboard.model') }}">
                            <i class="fa fa-map-marker text-dark" aria-hidden="true"></i>
                            <span class="side-menu__label mr-2">  الموديلات  </span>
                        </a>
					</li>
                    <li class="slide">
						<a class="side-menu__item" href="{{ route('dashboard.category') }}">
                            <i class="fa fa-map-marker text-dark" aria-hidden="true"></i>
                            <span class="side-menu__label mr-2"> الفئات   </span>
                        </a>
					</li>

                    <li class="side-item side-item-category">السيارات الجديدة</li>
					<li class="slide">
						<a class="side-menu__item" href="{{ route('dashboard.new.car') }}">
                            <i class="fa fa-map-marker text-dark" aria-hidden="true"></i>
                            <span class="side-menu__label mr-2"> اضافة سيارة جديدة </span>
                        </a>
					</li>
                    <li class="slide">
						<a class="side-menu__item" href="{{ route('view.new.cars') }}">
                            <i class="fa fa-map-marker text-dark" aria-hidden="true"></i>
                            <span class="side-menu__label mr-2"> عرض سيارة جديدة </span>
                        </a>
					</li>

                    <li class="side-item side-item-category">اخبار سيارات</li>
					<li class="slide">
						<a class="side-menu__item" href="{{ route('dashboard.news') }}">
                            <i class="fa fa-map-marker text-dark" aria-hidden="true"></i>
                            <span class="side-menu__label mr-2"> الاخبار </span>
                        </a>
					</li>

					<li class="side-item side-item-category">الولايات</li>
					<li class="slide">
						<a class="side-menu__item" href="{{ route('dashboard.states') }}">
                            <i class="fa fa-map-marker text-dark" aria-hidden="true"></i>
                            <span class="side-menu__label mr-2"> عرض كل الولايات </span>
                        </a>
					</li>
                    <li class="side-item side-item-category">الاعدادات</li>
					<li class="slide">
						<a class="side-menu__item" href="{{ route('dashboard.header_image') }}">
                            <i class="fa fa-map-marker text-dark" aria-hidden="true"></i>
                            <span class="side-menu__label mr-2"> صور الاعلانية </span>
                        </a>
					</li>
					<li class="slide">
						<a class="side-menu__item" href="{{ route('dashboard.setting') }}">
                            <i class="fa fa-map-marker text-dark" aria-hidden="true"></i>
                            <span class="side-menu__label mr-2"> اعدادات الروابط </span>
                        </a>
					</li>
					...
					{{-- <li class="side-item side-item-category">الولايات</li>
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M4 12c0 4.08 3.06 7.44 7 7.93V4.07C7.05 4.56 4 7.92 4 12z" opacity=".3"/><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.94-.49-7-3.85-7-7.93s3.05-7.44 7-7.93v15.86zm2-15.86c1.03.13 2 .45 2.87.93H13v-.93zM13 7h5.24c.25.31.48.65.68 1H13V7zm0 3h6.74c.08.33.15.66.19 1H13v-1zm0 9.93V19h2.87c-.87.48-1.84.8-2.87.93zM18.24 17H13v-1h5.92c-.2.35-.43.69-.68 1zm1.5-3H13v-1h6.93c-.04.34-.11.67-.19 1z"/></svg><span class="side-menu__label">عرض كل الولايات</span><i class="angle fe fe-chevron-down"></i></a>
					</li>
					<li class="slide">
